# Privacy Policy for Istichara

**Last Updated:** January 6, 2025

Welcome to Istichara! We are committed to protecting your privacy and ensuring that your personal information is handled in a safe and responsible manner. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you use our mobile application ("Istichara"). Please read this policy carefully to understand our views and practices regarding your personal data.

## 1. Introduction

Istichara ("we," "us," or "our") is a mobile application designed to support mobile merchants with point-of-sale functionality, inventory management, supplier management, customer relationship management, analytics, and seamless integration with other platforms. Your privacy is important to us, and we are dedicated to safeguarding your personal information.

By using Istichara, you agree to the collection and use of information in accordance with this Privacy Policy.

## 2. Information We Collect

### a. **Personal Information**

When you use Istichara, we may collect the following personal information:
...
- **Account Credentials:** Username and password for accessing your Istichara account.
...
We may also collect information on how Istichara is accessed and used ("Usage Data"). This Usage Data may include:
...
Istichara uses cookies and similar tracking technologies to enhance your experience:
...
- **To Provide and Maintain the App:** Ensure the functionality and performance of Istichara.
...
Istichara is not intended for use by individuals under the age of 18. We do not knowingly collect personal information from children. If we become aware that we have inadvertently received personal information from a child under 18, we will take steps to delete such information promptly.
...
- **Email:** [beladel.ilyes@gmail.com](mailto:beladel.ilyes@gmail.com)

---

*This Privacy Policy was created using standard privacy policy guidelines and is tailored to the features and functionalities of the Istichara app. For comprehensive legal advice, please consult a qualified attorney.*
